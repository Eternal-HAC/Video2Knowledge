...
- `app/transcript.py`: transcript provider boundary with Mock implementation, YouTube official VTT/WebVTT subtitles, fallback eligibility policy, and real fallback placeholder. Does not use automatic captions, transcript API fallback, audio acquisition, or Whisper execution.
