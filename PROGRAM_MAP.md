...
- `app/audio.py`: Mock audio acquisition and normalization boundaries for fallback orchestration. Does not read media, write audio files, check ffmpeg, run ffmpeg, or manage cache/temp workspaces yet.
